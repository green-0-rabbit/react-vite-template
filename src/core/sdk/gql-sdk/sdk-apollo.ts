...
import { getSdk, Requester } from "./api-sdk";

export type ApolloRequesterOptions<V = OperationVariables, R = any> =
...
export function getSdkApollo<C>(client: ApolloClient<C>) {
  const requester: Requester<ApolloRequesterOptions> = async <R, V>(
    doc: DocumentNode,
    variables: V,
